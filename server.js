...
// Remove this line - DON'T disable SSL verification
// process.env.NODE_TLS_REJECT_UNAUTHORIZED = '0';

// Create MongoClient with proper options
const client = new MongoClient(uri, {
  ...
  tls: true,
  tlsAllowInvalidCertificates: true, // This is sometimes needed for Windows
  retryWrites: true,
  w: 'majority'
});
